 ...
 * @author thevpc
 */
public class DefaultNSiteMimeTypeResolver implements NSiteMimeTypeResolver {
    ...
    public DefaultNSiteMimeTypeResolver() {
    }
     ...
     */
    public DefaultNSiteMimeTypeResolver copy(){
        DefaultNSiteMimeTypeResolver copy = new DefaultNSiteMimeTypeResolver();
    ...
    public DefaultNSiteMimeTypeResolver setNameMimeType(String name, String mimeType) {
        checkImmutable();
        if (mimeType == null) {
    ...
    public DefaultNSiteMimeTypeResolver setExtensionMimeType(String extension, String mimeType) {
        checkImmutable();
        if (mimeType == null) {
    ...
    public NSiteMimeTypeResolver setImmutable() throws IllegalArgumentException {
        this.immutable = true;
        return this;
    }
    ...
    public String resolveMimetype(String path) {
        try {
            ...
            Logger.getLogger(DefaultNSiteMimeTypeResolver.class.getName()).log(Level.SEVERE, null, ex);
        }

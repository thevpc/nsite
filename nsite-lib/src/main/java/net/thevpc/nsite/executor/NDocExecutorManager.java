...
import net.thevpc.nsite.processor.impl.DefaultNDocStreamExecutor;
...
public class NDocExecutorManager {
    private static final NDocExecutor NEXPR_EXECUTOR = new StreamToExecutor(new DefaultNDocStreamExecutor(new DefaultNDocExprEvaluator()));
    ...
    public NDocExecutorManager setDefaultExecutor(String mimetype, net.thevpc.nsite.executor.NDocExprEvaluator executor) {

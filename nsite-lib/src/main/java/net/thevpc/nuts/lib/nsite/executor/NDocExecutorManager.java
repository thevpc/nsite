...
import net.thevpc.nuts.lib.nsite.mimetype.MimeTypeConstants;
import net.thevpc.nuts.lib.nsite.processor.impl.DefaultNDocStreamExecutor;
...
public class NDocExecutorManager {
    ...
    public NDocExecutorManager setDefaultExecutor(String mimetype, net.thevpc.nuts.lib.nsite.executor.NDocExprEvaluator executor) {
